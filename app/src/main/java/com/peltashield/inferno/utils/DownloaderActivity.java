 ...
 */
public class DownloaderActivity extends ActionBarActivity implements IDownloaderClient {
    ...
    private static final XAPKFile[] xAPKS = {
            new XAPKFile(
                    ...
                    Configs.EXP_FILE_VERSION, // the version of the APK that the file was uploaded
                    // against
                    Configs.EXP_FILE_SIZE // the length of the file in bytes
            )
    };
    ...
    boolean expansionFilesDelivered() {
        //String fileName = Helpers.getExpansionAPKFileName(this, true, Configs.EXP_FILE_VERSION);
        //return Helpers.doesFileExist(this, fileName, Configs.EXP_FILE_SIZE, false);
    ...
    private void initializeDownloadUI() {
        mDownloaderClientStub = DownloaderClientMarshaller.CreateStub
                (this, InfernoDownloaderService.class);
        ...
        if (!expansionFilesDelivered()) {
            ...
            try {
                ...
                int startResult = DownloaderClientMarshaller.startDownloadServiceIfRequired(this,
                        pendingIntent, InfernoDownloaderService.class);
